...
import apps.lnsel.com.vhortexttest.views.Dashboard.activities.GroupChatScreen.GroupShareScreen.GroupShareMsgView;

/**
 * Created by db on 2/26/2018.
 */

public class GroupShareMsgPresenter {

    private GroupShareMsgView view;
    private static final String TAG = "REQ_CHAT";
    public GroupShareMsgPresenter(GroupShareMsgView view) {
        this.view = view;
    }
