...
public class ActivityViewLocation extends FragmentActivity implements OnMapReadyCallback {
    ...
    private void getValuesFromIntent() {
        ...
        if (mBundle != null && mBundle.containsKey(ConstantChat.B_RESULT)) {
            mDataTextChat = (ChatData) mBundle.getParcelable(ConstantChat.B_RESULT);
        }
    }
