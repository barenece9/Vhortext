...
import apps.lnsel.com.vhortexttest.views.Dashboard.activities.FindPeopleScreen.searchNearByUser.SearchNearByUsersView;

/**
 * Created by db on 12/1/2017.
 */

public class SearchNearByUsersPresenter {

    SearchNearByUsersView view;
    JSONObject e;
    JSONArray data;
    public SearchNearByUsersPresenter(SearchNearByUsersView view){
        this.view = view;
    }
