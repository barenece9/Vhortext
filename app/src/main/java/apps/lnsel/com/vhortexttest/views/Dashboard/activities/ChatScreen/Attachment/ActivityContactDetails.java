...
import apps.lnsel.com.vhortexttest.adapters.AdapterContactDetails;
...
public class ActivityContactDetails extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        startActivityForResult(new Intent(Intent.ACTION_PICK, ContactsContract.Contacts.CONTENT_URI), ConstantChat.ContactSelect);
            ...
            case (ConstantChat.ContactSelect):
                if (resultCode == Activity.RESULT_OK) {
                    if (data != null) {
                        ...
                        mArrayList = CommonMethods.getContact(ActivityContactDetails.this, contactData);
    ...
    public void save(){
        ...
        if (mContactSetget!=null&&!TextUtils.isEmpty(mContactSetget.getContactNumber())) {
            ...
            mBundle.putSerializable(ConstantChat.B_RESULT, mContactSetget);
            resultIntent.putExtras(mBundle);
            setResult(Activity.RESULT_OK, resultIntent);
            finish();
        } else {
            ToastUtil.showAlertToast(ActivityContactDetails.this, getString(R.string.contact_pick_no_number), ToastType.FAILURE_ALERT);
    ...
    public void Call(String Phone){
        ...
        if (!hasPermissionCall) {
            ActivityCompat.requestPermissions(ActivityContactDetails.this,
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            ...
            case ConstantChat.Call: {
                ...
                {
                    Toast.makeText(ActivityContactDetails.this, "Call Permission granted.", Toast.LENGTH_SHORT).show();
                } else
                {
                    Toast.makeText(ActivityContactDetails.this, "The app was not allowed to call. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
                break;
            }
        }
