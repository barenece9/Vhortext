...
import apps.lnsel.com.vhortexttest.views.OTPConfirmationScreen.OTPConfirmationActivityView;

/**
 * Created by apps2 on 7/11/2017.
 */
public class OTPConfirmationPresenter {

    private OTPConfirmationActivityView view;
    private static final String TAG = "REQ";

    public OTPConfirmationPresenter(OTPConfirmationActivityView view) {
        this.view = view;
    }
