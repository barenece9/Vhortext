...
public class AdapterSearchMyVhortextContact extends BaseAdapter {
    ...
    public AdapterSearchMyVhortextContact(Context mContext, ArrayList<ContactData> mListContact) {
