...
import apps.lnsel.com.vhortexttest.adapters.AdapterImageSelection;
import apps.lnsel.com.vhortexttest.adapters.AdapterPagerImage;
...
public class ActivityShareImage extends Activity implements AdapterImageSelection.StartActivityResult {
...
//                    initAdapter(mListString);
        ...
        if (mBundle != null && mBundle.getBoolean(ConstantChat.B_CAMERA_INMAGE)) {
            ...
            if (mBundle != null && mBundle.containsKey(ConstantChat.B_TYPE)) {
                ...
                mDataShareImage.setImgUrl(mBundle.getString(ConstantChat.B_RESULT));
                mListString.add(mDataShareImage);
            }
        }
        ...
        tvSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                setResult(ConstantChat.ChatToSelection, mIntent);
                finish();
            }
        });
        ...
        mChatGridLayoutManager = new ChatGridLayoutManager(ActivityShareImage.this, 5, GridLayoutManager.VERTICAL, false);
    ...
    public void startActivity() {
        ...
        Bundle mBundle = new Bundle();
        mBundle.putSerializable(ConstantChat.B_TYPE, ConstantChat.SELECTION.SELECTION_TO_IMAGE);
        mBundle.putSerializable(ConstantChat.B_RESULT, mListString);
        mIntent.putExtras(mBundle);
        startActivityForResult(mIntent, ConstantChat.ImagePickerSelection);
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == ConstantChat.ImagePickerSelection && resultCode == ConstantChat.ImageResultSelection) {
