...
import apps.lnsel.com.vhortexttest.views.ContactSyncScreen.ContactSyncActivityView;

/**
 * Created by apps2 on 7/11/2017.
 */
public class ContactSyncPresenter {

    private ContactSyncActivityView view;
    ...
    public ContactSyncPresenter(ContactSyncActivityView view) {
        this.view = view;
    }
