...
public class ActivityGroupYoutubePlayer extends YouTubeBaseActivity implements
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(R.layout.activity_group_youtube_video_player);
        ...
        if(videoId.equalsIgnoreCase("")){
            Toast.makeText(ActivityGroupYoutubePlayer.this, "Invalid video Url", Toast.LENGTH_SHORT).show();
            finish();
            return;
        }else {
            if(videoId.equalsIgnoreCase("")){
        ...
        if(!InternetConnectivity.isConnectedFast(ActivityGroupYoutubePlayer.this)){
            return;
        }
