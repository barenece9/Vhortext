...
public class AdapterAddPeopleInGroup extends RecyclerView.Adapter<AdapterAddPeopleInGroup.VH>  {
    ...
    public AdapterAddPeopleInGroup(Context mContext, ArrayList<GroupContactData> mListContact , ImageLoader mImageLoader) {
...
//        final DataContactForGroup mDataContact = ;
    ...
    private void onSelect(int position) {
        ...
        if(mContext instanceof ActivityAddPeopleInGroup){
            ((ActivityAddPeopleInGroup)mContext).OnClickPerformed(mListContact,selectedMemberId);
        }
    }
