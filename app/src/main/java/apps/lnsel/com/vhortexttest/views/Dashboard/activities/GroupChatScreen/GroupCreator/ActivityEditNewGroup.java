...
import apps.lnsel.com.vhortexttest.views.Dashboard.activities.GroupChatScreen.GroupEditImage.GroupEditPhotoActivity;


public class ActivityEditNewGroup extends AppCompatActivity implements
    ...
    private void initComponent() {
        ...
        toolbar_custom_ivbtn_back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                releaseBitmap();
                new ActivityUtil(ActivityEditNewGroup.this).startMainActivity(true);
            }
        });
            ...
            public void onClick(View view) {
                ...
                if (et_name.getText().toString().trim().length() > 0) {
                    ...
                    if(et_name_group_prefix.getText().toString().trim().length() == 3){
                        ...
                        Intent mIntent = new Intent(ActivityEditNewGroup.this, ActivityEditPeopleInGroup.class);
                        mIntent.putExtra("groupname", et_name.getText().toString().trim());
                        mIntent.putExtra("groupimg", mCropImageUri);
                        startActivity(mIntent);
                        finish();
                    }else {
                        ToastUtil.showAlertToast(ActivityEditNewGroup.this, "Group prefix must be 3 characters.", ToastType.FAILURE_ALERT);
                    }
                } else {
                    ToastUtil.showAlertToast(ActivityEditNewGroup.this, "Group name cannot be left blank.", ToastType.FAILURE_ALERT);
                }
            }
        });
        // end toolbar section.........................................................................
        ...
        et_name.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                if (et_name.getText().toString().length() == 25) {
                    ToastUtil.showAlertToast(ActivityEditNewGroup.this, "Exceeded max length", ToastType.FAILURE_ALERT);
                    hideSoftKeyboard(ActivityEditNewGroup.this, et_name);
                }
        ...
        iv_smiley.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                keyboardEvent();
                hideSoftKeyboard(ActivityEditNewGroup.this, view);
                showSmiley(true);
            }
        });
        ...
        //et_name_group_prefix.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start,
                ...
                if (et_name_group_prefix.getText().toString().length() > 3) {
                    ...
                    /*hideSoftKeyboard(ActivityEditNewGroup.this, et_name_group_prefix);
                    showSmiley(false);
                    emojicons.setVisibility(View.GONE);*/
    ...
    public void checkStoragePermission(){
        ...
        if (!hasPermissionWrite) {
            ActivityCompat.requestPermissions(ActivityEditNewGroup.this,
    ...
    protected void imageIntentChooser() {
        if (CropImage.isExplicitCameraPermissionRequired(ActivityEditNewGroup.this)) {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                requestPermissions(new String[]{Manifest.permission.CAMERA}, CropImage.CAMERA_CAPTURE_PERMISSIONS_REQUEST_CODE);
            }
        } else {
            CropImage.startPickImageActivity(ActivityEditNewGroup.this);
        }
    ...
    public void onRequestPermissionsResult(int requestCode, String permissions[], int[] grantResults) {
        ...
        if (requestCode == CropImage.PICK_IMAGE_PERMISSIONS_REQUEST_CODE) {
            if (mCropImageUri != null && grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                ...
                Intent intent=new Intent(ActivityEditNewGroup.this,GroupEditPhotoActivity.class);
        ...
        if(requestCode==REQUEST_WRITE_STORAGE)  {
            ...
            {
                imageIntentChooser();
                Toast.makeText(ActivityEditNewGroup.this, "Storage Permission granted.", Toast.LENGTH_SHORT).show();
            } else
            {
                Toast.makeText(ActivityEditNewGroup.this, "The app was not allowed to write to your storage. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
            }
        }
    }
