...
import apps.lnsel.com.vhortexttest.views.Dashboard.activities.GroupChatScreen.GroupCreator.EditPeopleInGroupScreen.ActivityEditPeopleInGroupView;


/**
 * Created by db on 9/22/2017.
 */
public class EditPeopleInGroupPresenter {

    private ActivityEditPeopleInGroupView view;

    public EditPeopleInGroupPresenter(ActivityEditPeopleInGroupView view) {
        this.view = view;
    }
    ...
    public void UpdateGroup(
        ...
        StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(status.equalsIgnoreCase("success")){
                                view.UpdateGroupSuccessInfo(response);
                            }else if(status.equals("notactive")){
                                view.notActiveUpdateGroupInfo(statusCode,status,message);
                            }else {
                                view.UpdateGroupErrorInfo("");
                            }
            ...
            protected Map<String, String> getParams()
            {
                ...
                params.put("grpMyUserId",grpMyUserId);
    ...
    public void addGroupNotificationAddMessage(String url, final String API_KEY, final GroupChatData groupChatData,final String usrDeviceId){
