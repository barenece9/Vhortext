 ...
 */
public final class ContactUsEditPhotoFragment extends Fragment
        implements CropImageView.OnSetImageUriCompleteListener, CropImageView.OnCropImageCompleteListener {

    //region: Fields and Consts

    private ContactUsCropDemoPreset mDemoPreset;
     ...
     */
    public static ContactUsEditPhotoFragment newInstance(ContactUsCropDemoPreset demoPreset) {
        ContactUsEditPhotoFragment fragment = new ContactUsEditPhotoFragment();
    ...
    public void updateCurrentCropViewOptions() {
        ContactUsCropImageViewOptions options = new ContactUsCropImageViewOptions();
        ...
        ((ContactUsEditPhotoActivity) getActivity()).setCurrentOptions(options);
    }
    ...
    public void onViewCreated(View view, Bundle savedInstanceState) {
        ...
        setImageUri(Constant.mCropImageUri1);
    }
    ...
    public void onAttach(Activity activity) {
        ...
        mDemoPreset = ContactUsCropDemoPreset.valueOf(getArguments().getString("DEMO_PRESET"));
        ((ContactUsEditPhotoActivity) activity).setCurrentFragment(this);
    }
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        if (result.getError() == null) {
            ...
            if (result.getUri() != null) {
                ...
                ContactUsActivity.mImage = mCropImageView.getCropShape() == CropImageView.CropShape.OVAL
