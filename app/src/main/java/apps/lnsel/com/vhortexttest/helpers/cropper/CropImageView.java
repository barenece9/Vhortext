...
public class CropImageView extends FrameLayout {
    ...
    /**
     * The activity_sketch_menu_bg_focussed size the image was loaded by if was loaded by URI
     */
  ...
  /*  public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
    ...
    /**
     * Gets the cropped image based on the current crop window.<br>
     * If (reqWidth,reqHeight) is given AND image is loaded from URI cropping will try to use activity_sketch_menu_bg_focussed size to fit in
    ...
    public enum RequestSizeOptions {
        ...
        /**
         * Only activity_sketch_menu_bg_focussed the image during loading (if image set using URI) so the smallest of the image
    ...
    public static class CropResult {
        ...
        /**
         * activity_sketch_menu_bg_focussed size used creating the crop bitmap to lower its size
         */
