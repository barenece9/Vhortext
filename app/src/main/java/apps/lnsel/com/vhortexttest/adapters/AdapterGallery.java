...
import apps.lnsel.com.vhortexttest.views.Dashboard.activities.ChatScreen.Attachment.InterfaceGallerySelect;
...
public class AdapterGallery extends BaseAdapter {
    ...
    public AdapterGallery(Context context, boolean isChat, ConstantChat.SELECTION mSelection, OnGridItemClick mCallback,
    ...
    public AdapterGallery(Context context, boolean isChat, ConstantChat.SELECTION mSelection, ArrayList<DataShareImage> mListStrings, OnGridItemClick mCallback, InterfaceGallerySelect mInterfaceGallerySelect) {
        mContext = context;
        this.isChat = isChat;
        this.mSelection = mSelection;
        this.mCallback = mCallback;
