 ...
 */
public final class GroupAddPhotoFragment extends Fragment
     ...
     */
    public static GroupAddPhotoFragment newInstance(GroupCropDemoPreset demoPreset) {
        GroupAddPhotoFragment fragment = new GroupAddPhotoFragment();
    ...
    public void updateCurrentCropViewOptions() {
        ...
        ((GroupAddPhotoActivity) getActivity()).setCurrentOptions(options);
    }
    ...
    public void onAttach(Activity activity) {
        ...
        ((GroupAddPhotoActivity) activity).setCurrentFragment(this);
    }
    ...
    private void handleCropResult(CropImageView.CropResult result) {
        if (result.getError() == null) {
            Intent intent = new Intent(getActivity(), ActivityCreateNewGroup.class);
            intent.putExtra("SAMPLE_SIZE", result.getSampleSize());
            if (result.getUri() != null) {
                intent.putExtra("URI", result.getUri());

            } else {
                ActivityCreateNewGroup.mImage = mCropImageView.getCropShape() == CropImageView.CropShape.OVAL
