...
public class AdapterGroupYahooNewsList extends RecyclerView.Adapter<AdapterGroupYahooNewsList.VH> {
    ...
    public AdapterGroupYahooNewsList(Context mContext) {
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VH((LayoutInflater.from(parent.getContext())).inflate(R.layout.inflater_group_yahoo_news_list, parent, false));
    }
