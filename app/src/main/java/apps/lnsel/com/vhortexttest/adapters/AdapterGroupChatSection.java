...
public class AdapterGroupChatSection extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public AdapterGroupChatSection(Context mContext, int sectionResourceId, int textResourceId, RecyclerView.Adapter baseAdapter) {
