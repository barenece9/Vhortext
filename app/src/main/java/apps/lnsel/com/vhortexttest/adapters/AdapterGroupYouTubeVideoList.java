...
public class AdapterGroupYouTubeVideoList extends RecyclerView.Adapter<AdapterGroupYouTubeVideoList.VH> {
    ...
    public AdapterGroupYouTubeVideoList(Context mContext) {
    ...
    public AdapterGroupYouTubeVideoList(Context mContext, ArrayList<YouTubeVideo> mVideoList) {
        this.mContext = mContext;
        options = new DisplayImageOptions.Builder()
    ...
    public VH onCreateViewHolder(ViewGroup parent, int viewType) {
        return new VH((LayoutInflater.from(parent.getContext())).inflate(R.layout.inflater_group_youtube_video_list, parent, false));
    }
