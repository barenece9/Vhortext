...
class MultiTouchListener implements OnTouchListener {
            ...
            case MotionEvent.ACTION_UP:
                ...
                if (mCurrentCancelX == mPrevRawX || mCurrentCancelY == mPrevRawY) {
                    if (view instanceof TextView) {
                        Log.e("MultiTouch",((TextView) view).getText().toString());
                        System.out.println("MultiTouch Text : "+((TextView) view).getText().toString()+" ID : "
                                +((TextView) view).getId()+" X : "+((TextView) view).getX()
                                +" Y : "+((TextView) view).getY()/*+" Z : "+((TextView) view).getZ()*/);

                        if (onMultiTouchListener != null) {
                            onMultiTouchListener.onEditTextClickListener(((TextView) view).getText().toString(), ((TextView) view).getCurrentTextColor(),
                                    ((TextView) view).getX(),((TextView) view).getY());
                        }
                        if (onPhotoEditorSDKListener != null) {
                            onPhotoEditorSDKListener.onEditTextChangeListener(((TextView) view).getText().toString(), ((TextView) view).getCurrentTextColor(),
                                    ((TextView) view).getX(),((TextView) view).getY());
                        }
                    }
                }
    ...
    interface OnMultiTouchListener {
        void onEditTextClickListener(String text, int colorCode, float x, float y);
