...
package apps.lnsel.com.vhortexttest.helpers.cropper;
...
final class BitmapUtils {
    ...
    /**
     * Crop image bitmap from URI by decoding it with specific width and height to down-activity_sketch_menu_bg_focussed if required.<br>
    ...
    /**
     * Crop image bitmap from URI by decoding it with specific width and height to down-activity_sketch_menu_bg_focussed if required.
     *
    ...
    /**
     * Holds bitmap instance and the activity_sketch_menu_bg_focussed size that the bitmap was loaded/cropped with.
     */
    static final class BitmapSampled {
        ...
        /**
         * The activity_sketch_menu_bg_focussed size used to lower the size of the bitmap (1,2,4,8,...)
         */
