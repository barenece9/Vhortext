...
public class AdapterShareMsg extends BaseAdapter {
    ...
    public AdapterShareMsg(Context context, ArrayList<Object> personArray) {
    ...
    private void onSelect(int position) {
        ...
        if(context instanceof ShareMsgActivity){
            ((ShareMsgActivity)context).OnClickPerformed(selectedMemberId);
        }
    }
}