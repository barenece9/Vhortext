...
import apps.lnsel.com.vhortexttest.adapters.AdapterGroupAddToContact;
...
public class ActivityGroupAddToContact extends Activity {
    ...
    private AdapterGroupAddToContact mAdapterAddtoContact;
    String mDataTextChat;
    GroupContactSetget mContactSetget;
    ArrayList<GroupContactSetget> mDataTextChatArrayList = new ArrayList<GroupContactSetget>();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_activity_group_add_to_contact);
        getIntentValue();
        initView();
    }
    private void getIntentValue() {
        ...
        if (mBundle != null && mBundle.containsKey(ConstantGroupChat.B_RESULT))
            mDataTextChat = mBundle.getString(ConstantGroupChat.B_RESULT);

        String[] separated = mDataTextChat.split("123vhortext123");

        if (!TextUtils.isEmpty(separated[1])) {

            mContactSetget = new GroupContactSetget();
    ...
    private void initView() {
        ...
        mAdapterAddtoContact = new AdapterGroupAddToContact(this, mDataTextChatArrayList);
        ...
        tv_add_to_contact.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                addAsContactConfirmed(ActivityGroupAddToContact.this, mContactSetget);
     ...
     */
    public static void addAsContactConfirmed(Context context, GroupContactSetget person) {
    ...
    public void Call(String Phone){
        ...
        if (!hasPermissionCall) {
            ActivityCompat.requestPermissions(ActivityGroupAddToContact.this,
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        ...
        switch (requestCode)
        {
            ...
            case ConstantGroupChat.Call: {
                ...
                {
                    Toast.makeText(ActivityGroupAddToContact.this, "Call Permission granted.", Toast.LENGTH_SHORT).show();
                } else
                {
                    Toast.makeText(ActivityGroupAddToContact.this, "The app was not allowed to call. Hence, it cannot function properly. Please consider granting it this permission", Toast.LENGTH_LONG).show();
                }
                break;
            }
        }
